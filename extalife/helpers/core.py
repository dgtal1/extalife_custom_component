...
class Core():
    ...
    def __init__(self, config_entry: ConfigEntry):
        ...
        self._api = ExtaLifeAPI(self.hass.loop, on_connect_callback=self._on_reconnect_callback, on_disconnect_callback=self._on_disconnect_callback)
        ...
        self._options_change_remove_callback = config_entry.add_update_listener(options_change_callback)
    ...
    def async_signal_register(self, signal: str, target) -> Callable:
        ...
        _LOGGER.debug("async_signal_register(), signal: %s, signal_ext: %s, target: %s", signal, signal_ext, target)

        def async_remove_signal() -> None:
            """Remove signal listener."""
            _LOGGER.debug("async_remove_signal(), signal: %s, signal_ext: %s, target: %s", signal, signal_ext, target)
            try:
    ...
    def async_signal_send(self, signal: str, *args: Any) -> None:
        ...
        _LOGGER.debug("async_signal_send(), signal: %s, signal_int: %s, target_list: %s, *args: %s", signal, signal_int, target_list, args)
