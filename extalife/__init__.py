...
class ExtaLifeChannel(Entity):
    ...
    def async_state_notif_update_callback(self, *args):
    ...
    @callback
    def _on_conn_state_callback(self):
        """Called when API connection to controller resumes or fails"""
    ...
    def available(self):
        ...
        return (
            ...
            and self.core.api.is_connected
        )
...
class ExtaLifeController(Entity):
    ...
    @property
    def state(self) -> str:
        """Return the controller state. it will be either 'online' or 'unavailable'"""
        return "online"
